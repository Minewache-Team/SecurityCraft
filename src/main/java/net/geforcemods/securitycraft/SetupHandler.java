...
public class SetupHandler {
	...
	public static void init() {
		...
		SCContent.electrifiedIronFenceGate = new ElectrifiedIronFenceGateBlock().setCreativeTab(SecurityCraft.TECHNICAL_TAB).setRegistryName("reinforced_fence_gate").setTranslationKey("securitycraft:reinforcedFenceGate");
		...
		SCContent.electrifiedIronFence = new ElectrifiedIronFenceBlock(Material.IRON).setCreativeTab(SecurityCraft.TECHNICAL_TAB).setRegistryName("electrified_iron_fence").setTranslationKey("securitycraft:electrifiedIronFence");
		...
		SCContent.scannerDoor = new ScannerDoorBlock(Material.IRON).setCreativeTab(SecurityCraft.TECHNICAL_TAB).setRegistryName("scanner_door").setTranslationKey("securitycraft:scannerDoor");
		...
		SCContent.keypadDoor = new KeypadDoorBlock(Material.IRON).setCreativeTab(SecurityCraft.TECHNICAL_TAB).setRegistryName("keypad_door").setTranslationKey("securitycraft:keypad_door");
		...
		SCContent.displayCase = new DisplayCaseBlock(Material.IRON).setCreativeTab(SecurityCraft.TECHNICAL_TAB).setRegistryName("display_case").setTranslationKey("securitycraft:display_case");
		...
		SCContent.scannerDoorItem = new SpecialDoorItem(SCContent.scannerDoor).setRegistryName("scanner_door_item").setTranslationKey("securitycraft:scannerDoorItem").setCreativeTab(SecurityCraft.TECHNICAL_TAB);
		SCContent.secretSignItem = new SecretSignItem().setRegistryName("secret_sign_item").setTranslationKey("securitycraft:secretSignItem").setCreativeTab(SecurityCraft.TECHNICAL_TAB);
		SCContent.keypadDoorItem = new SpecialDoorItem(SCContent.keypadDoor).setRegistryName("keypad_door_item").setTranslationKey("securitycraft:keypad_door_item").setCreativeTab(SecurityCraft.TECHNICAL_TAB);
